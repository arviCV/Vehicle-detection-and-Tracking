...
For this project, I used a labeled dataset with 8,792 "vehicle" and 8,968 "non-vehicle" examples to train my classifier. These images come from a combination of the GTI vehicle image database and the KITTI vision benchmark suite.
...
The video output for this project can be found and the diagnotics video with the heatmaps overlaid on the video frames for visualization is added in the repo.
